	...
	$(document).ready(function(){
		...
		$('.recommendMidDelete').click(function(){
			if(confirm('정말 삭제하시겠어요??')){
				...
				$.ajax({
					type:"get",
					url:"member_deleteRecommendMidCategory.do?midCategory="+$(this).children('.midCategoryValue').val()
		...
		$('.babyChanger').change(function(){
			$.ajax({
				type:"get",
				url:"member_changeRecommendingBaby.do?babyName="+$(this).val()
		...
		$('.accordion-section').click(function(){
			...
			$.ajax({
				type:"get",
				url:"member_selectSmallProductRank.do?midCategoryId="+$(this).children('.midCategoryIdValue').val(),
		...
		function loadingPostingList(){
	    	...
	    	$.ajax({
	    		type : "get",
	    		url : "member_selectPostingBySmallProduct.do?pageNum="+pageNum+"&smallProductIdList="+smallProductId+"&memberId=${sessionScope.blliMemberVO.memberId}",
	    		success : function(data){
