...
$(document).ready(function(){
	...
	$(".postingScrapeBtn").click(function(){
		...
		$.ajax({
			type:"get",
			url:"member_postingScrape.do?memberId=${sessionScope.blliMemberVO.memberId}&smallProductId="+$(comp).parent().children('.smallProductIdInfo').val()
	...
	$(".postingLikeBtn").click(function(){
		...
		$.ajax({
			type:"get",
			url:"member_postingLike.do?memberId=${sessionScope.blliMemberVO.memberId}&smallProductId="+$(comp).parent().children('.smallProductIdInfo').val()
					+'&postingUrl='+$(comp).parent().children('.postingUrlInfo').val(),
			success:function(result){
				if(result==1){
	...
	$(".postingDisLikeBtn").click(function(){
		...
		$.ajax({
			type:"get",
			url:"member_postingDisLike.do?memberId=${sessionScope.blliMemberVO.memberId}&smallProductId="+$(comp).parent().children('.smallProductIdInfo').val()
					+'&postingUrl='+$(comp).parent().children('.postingUrlInfo').val(),
			success:function(result){
				if(result==1){
					$(comp).css('color','hotpink');
