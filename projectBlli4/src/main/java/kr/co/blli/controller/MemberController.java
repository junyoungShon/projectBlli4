...
public class MemberController {
	 ...
	 * @throws Exception 
	 */
	@RequestMapping("member_updateBabyInfo.do")
	...
	/**
	  ...
	  * @param request
	 */
	@RequestMapping("member_goModifyMemberInfoPage.do")
	...
	/**
	  ...
	  * @param request
	 */
	@RequestMapping("member_goModifyBabyInfoPage.do")
	...
	/**
	  ...
	  * @param request
	 */
	@RequestMapping("member_updateMemberInfoByEmail.do")
	...
	/**
	  ...
	  * @return
	 */
	@RequestMapping("member_changeRecommendingBaby.do")
	...
	/**
	  ...
	  * @return
	 */
	@RequestMapping("member_smallProductDib.do")
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping("member_postingLike.do")
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping("member_postingDisLike.do")
	@ResponseBody
